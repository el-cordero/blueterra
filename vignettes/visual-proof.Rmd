...
bathymetry. The line angle and `orientation_resultant_length` are recorded in
the transect attributes; a low resultant length signals an unstable automatic
mean direction.*
...
mark the depth horizons that were buffered to create independent extraction
corridors; overlapping corridor summaries are not mutually exclusive.*
