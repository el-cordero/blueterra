...
Online Resource 1 is a reproducible workflow report that describes the documented BlueTopo acquisition, terrain derivation, summaries, sensitivity analyses, validation, and computational assessment. Online Resource 2 is the accompanying code-and-results archive, including source scripts, machine-readable results, figure and table data, environment records, manifests, checksums, and the documented article data subset.
