...
![blueterra logo](reference/figures/logo.png)
...
[![License:
MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://el-cordero.github.io/blueterra/LICENSE.md)
...
returns installed file paths. The short aliases `"bathy"` and `"zones"`
point to the slope bathymetry and sampling rectangles. The explicitly
named `"synthetic_bathy"` and `"synthetic_zones"` fixtures are kept for
numerical tests.
...
reads a local raster file and returns a
[`terra::SpatRaster`](https://rspatial.github.io/terra/reference/SpatRaster-class.html).
[`as_bathy()`](https://el-cordero.github.io/blueterra/reference/as_bathy.md)
accepts either a path or an existing `SpatRaster`.
[`bathy_info()`](https://el-cordero.github.io/blueterra/reference/bathy_info.md)
prints the pieces of raster metadata that usually matter first:
dimensions, extent, cell size, value range, and CRS.
...
is available when a full sign reversal is the explicit operation being
performed.
...
This makes it clear which transformations affect the surface before
terrain derivatives are calculated.
...
is a local Laplacian-style curvature index; it should not be interpreted
as profile curvature or plan curvature.
...
![Slope clip bathymetry with hillshade, contours, and sampling
rectangles.](reference/figures/README-map-slope-clip-1.png)
...
![Hole-in-the-Wall bathymetry with hillshade and
contours.](reference/figures/README-map-hitw-1.png)
...
![El Hoyo bathymetry with hillshade and
contours.](reference/figures/README-map-hoyo-1.png)
...
![Slope metric over hillshaded
bathymetry.](reference/figures/README-map-metrics-1.png)
...
![Mean slope summarized by sampling
rectangle.](reference/figures/README-plot-polygon-summary-1.png)
...
estimates the transect direction from the slope-weighted mean aspect of
the clipped bathymetry. An explicit `angle` remains the correct choice
when the analysis requires a fixed survey bearing.
...
![Transects over hillshaded Hole-in-the-Wall
bathymetry.](reference/figures/README-plot-transects-1.png)
...
![Bathymetric cross-section profiles with depth increasing
downward.](reference/figures/README-plot-cross-sections-1.png)
...
bathymetry.](reference/figures/README-plot-isobaths-1.png)
...
bathymetry.](reference/figures/README-plot-isobath-corridors-1.png)
...
metrics.](reference/figures/README-plot-pca-1.png)
...
![Hole-in-the-Wall PCA scores for sampled terrain
metrics.](reference/figures/README-plot-pca-hitw-1.png)
...
![El Hoyo PCA scores for sampled terrain
metrics.](reference/figures/README-plot-pca-hoyo-1.png)
...
![Metric stack preview for slope, TRI, BPI, and
curvature.](reference/figures/README-plotting-stack-1.png)
...
bathymetry.](reference/figures/README-plotting-rugosity-1.png)
...
![BPI over hillshaded
bathymetry.](reference/figures/README-plotting-bpi-1.png)
...
bathymetry.](reference/figures/README-plotting-curvature-1.png)
...
bathymetry.](reference/figures/README-plotting-surface-ratio-1.png)
...
![Process-density plot for slope
values.](reference/figures/README-plotting-density-1.png)
...
![Depth profile along one
transect.](reference/figures/README-plotting-depth-profile-1.png)
...
transect.](reference/figures/README-plotting-slope-profile-1.png)
...
bathymetry.](reference/figures/README-custom-metric-plot-1.png)
...
[`terra::SpatRaster`](https://rspatial.github.io/terra/reference/SpatRaster-class.html)
objects or compact metadata tables.
...
[`read_bathy()`](https://el-cordero.github.io/blueterra/reference/read_bathy.md)
is the file-path entry point;
[`as_bathy()`](https://el-cordero.github.io/blueterra/reference/as_bathy.md)
is useful inside workflows that already hold a raster object.
...
Each metric function returns a
[`terra::SpatRaster`](https://rspatial.github.io/terra/reference/SpatRaster-class.html).
The stack helpers return a multi-layer `SpatRaster` with clean layer
names.
...
objects or local vector paths and return vectors, extracted cells, or
summary tables.
